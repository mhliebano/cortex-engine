...
class WindowManager {
  ...
  WindowManager() {
    ...
    _getPositionX = dylib
        .lookupFunction<WindowGetPositionXC, WindowGetPositionX>(
          'window_get_position_x',
        );
    _getPositionY = dylib
        .lookupFunction<WindowGetPositionYC, WindowGetPositionY>(
          'window_get_position_y',
        );
    _setTargetFps = dylib
        .lookupFunction<WindowSetTargetFpsC, WindowSetTargetFps>(
