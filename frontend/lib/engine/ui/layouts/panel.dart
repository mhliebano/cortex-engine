...
class Panel extends Element {
  ...
  void _updateChildBounds() {
    ...
    final isWidthConstrained = _isWidthFixed || fillWidth || expand == Expand.all || expand == Expand.width;
    final isHeightConstrained = _isHeightFixed || fillHeight || expand == Expand.all || expand == Expand.height;
    ...
    if ((child!.isFlexHeight || child!.height == 0 || isHeightConstrained) && availableHeight > 0) {
