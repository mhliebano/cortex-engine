...
class IconButton extends Element {
  ...
  void onRender(Context2D ctx2d, Context3D ctx3d) {
    ...
    final IconData activeIcon = (isToggle && isSelected && selectedIcon != null) ? selectedIcon! : icon;
    ...
    if (!enabled) {
      bg = variant == IconButtonVariant.standard ? ColorRGBA.transparent : const ColorRGBA(60, 64, 72, 80);
      ...
      switch (variant) {
        ...
        case IconButtonVariant.filled:
          ...
          bg = _isPressed
              ...
              : _isHovered
                  ? const ColorRGBA(52, 152, 219)
                  : (active ? const ColorRGBA(41, 128, 185) : const ColorRGBA(45, 50, 60));
        ...
        case IconButtonVariant.tonal:
          bg = _isPressed
              ...
              : _isHovered
                  ...
                  : (isSelected ? const ColorRGBA(40, 80, 110) : const ColorRGBA(35, 42, 54));
          fg = isSelected ? const ColorRGBA(130, 200, 255) : const ColorRGBA(190, 200, 215);
          break;
        ...
        case IconButtonVariant.outlined:
          bg = _isPressed
              ...
              : _isHovered
                  ...
                  : (isSelected ? const ColorRGBA(41, 128, 185, 30) : ColorRGBA.transparent);
          fg = isSelected ? const ColorRGBA(100, 180, 240) : const ColorRGBA(200, 210, 225);
          border = _isHovered || isSelected ? const ColorRGBA(52, 152, 219) : const ColorRGBA(75, 85, 100);
          break;
      }
    }
