...
class ProgressBar extends Element {
  ...
  ProgressBar({
    ...
    valueColor = style?.accentColor ?? style?.borderColor ?? ColorRGBA.accentBlue;
  ...
  void onRender(Context2D ctx2d, Context3D ctx3d) {
    ...
    ctx2d.drawRoundRectLines(x, barY, width, barH, roundness, color: const ColorRGBA(55, 65, 82));
    ...
    if (value != null) {
      ...
      ctx2d.drawRoundRect(pulseX, barY, pulseW.toInt(), barH, roundness, color: valueColor);
      ctx2d.endScissor();
    }
  }
}
