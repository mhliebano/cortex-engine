...
class SegmentedButton extends Element {
  ...
  void onRender(Context2D ctx2d, Context3D ctx3d) {
    ...
    ctx2d.drawRoundRect(x, y, width, height, 0.4, color: const ColorRGBA(30, 35, 45));
    ctx2d.drawRoundRectLines(x, y, width, height, 0.4, lineThick: 1.0, color: const ColorRGBA(65, 72, 85));
    ...
    for (int i = 0; i < count; i++) {
      ...
      final int totalW = iconW + (item.icon != null && item.label.isNotEmpty ? 6 : 0) + textW;
