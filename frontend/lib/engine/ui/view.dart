...
import 'package:cortex/engine/ui/interaction/toast.dart';
import 'package:cortex/engine/ui/interaction/snack_bar.dart';
import 'package:cortex/engine/ui/interaction/dialog.dart';
export 'package:cortex/engine/ui/element.dart';
...
class View {
  ...
  Map<String, Map<String, dynamic>> _collectElementStates(List<Element> elements, [String prefix = '']) {
  ...
  void _restoreElementStates(List<Element> elements, Map<String, Map<String, dynamic>> states, [String prefix = '']) {
    final Map<String, int> typeCounts = {};
  ...
  void update(double dt, InputEngine input) {
    ...
    Dialog.updateActiveDialog(dt, input, width > 0 ? width : 1280, height > 0 ? height : 720);
  }
  ...
  void _renderInternal(Context2D ctx2d, Context3D ctx3d) {
    ...
    Toast.renderActiveToasts(ctx2d, ctx3d, width > 0 ? width : 1280, height > 0 ? height : 720);
    SnackBar.renderActiveSnackBar(ctx2d, ctx3d, width > 0 ? width : 1280, height > 0 ? height : 720);
    Dialog.renderActiveDialog(ctx2d, ctx3d, width > 0 ? width : 1280, height > 0 ? height : 720);
  }
