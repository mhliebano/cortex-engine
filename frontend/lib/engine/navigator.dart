import 'package:cortex/engine/ui/desktop/desktop_layout.dart';
import 'package:cortex/engine/ui/layouts/column.dart';
...
class Navigator {
  ...
  static void Function(String route, ViewBuilder builder)? _routeRegistrationHandler;
  ...
  static void setRegisterHandler(void Function(String route, ViewBuilder builder) handler) {
  ...
  static void pushNamed(String route, {bool fullscreen = false}) => to(route, fullscreen: fullscreen);
  static void push(String route, {bool fullscreen = false}) => to(route, fullscreen: fullscreen);
}
