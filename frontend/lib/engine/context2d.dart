import 'package:cortex/graphics2d.dart';
...
class Context2D {
  ...
  void drawPanel(int x, int y, int w, int h, {ColorRGBA bgColor = ColorRGBA.darkGray, ColorRGBA borderColor = ColorRGBA.lightGray}) {
    _g2d.drawRect(x, y, w, h, bgColor.r, bgColor.g, bgColor.b, bgColor.a);
    if (borderColor.a > 0 && w > 1 && h > 1) {
      _g2d.drawRectLines(x, y, w - 1, h - 1, borderColor.r, borderColor.g, borderColor.b, borderColor.a);
    }
  }
  ...
  void drawText(String text, int x, int y, int fontSize, [ColorRGBA color = ColorRGBA.white]) {
  ...
  bool drawButton(
    ...
    final textX = x + 15;
    final textY = y + (h ~/ 4);
    _g2d.drawText(label, textX, textY, fontSize, textColor.r, textColor.g, textColor.b, textColor.a);
  ...
  void drawCircle(int centerX, int centerY, double radius, ColorRGBA color) {
    _g2d.drawCircle(centerX, centerY, radius, color.r, color.g, color.b, color.a);
  }

  void drawCircleLines(int centerX, int centerY, double radius, ColorRGBA color) {
    _g2d.drawCircleLines(centerX, centerY, radius, color.r, color.g, color.b, color.a);
  }
  ...
  void drawRoundRect(
    ...
    _g2d.drawRoundRect(x, y, w, h, roundness, segments, color.r, color.g, color.b, color.a);
  }
  ...
  void drawPoly(
    ...
    _g2d.drawPoly(centerX, centerY, sides, radius, rotation, color.r, color.g, color.b, color.a);
  }
  ...
  void drawTriangle(
    ...
    _g2d.drawTriangle(x1, y1, x2, y2, x3, y3, color.r, color.g, color.b, color.a);
  }
  ...
  void drawTriangleLines(
    ...
    _g2d.drawTriangleLines(x1, y1, x2, y2, x3, y3, color.r, color.g, color.b, color.a);
  }
}
