...
class Button extends Element {
  ...
  Button({
    ...
    final int autoWidth = (textLen * (fontSize * 0.55) + 32 + iconPad)
        .toInt()
        .clamp(80, 500);
  ...
  void onRender(Context2D ctx2d, Context3D ctx3d) {
    ...
    final int textWidth = label.isNotEmpty
        ? (label.length * (fontSize * 0.55)).toInt()
        : 0;
    final int totalContentWidth =
        iconWidth + (icon != null && label.isNotEmpty ? 8 : 0) + textWidth;
